...
class EstimatingLearner {
	...
	private static class WorkerEstimator {
		// private final EstimatorInterface performance = new
		// GaussianEstimator();
		private final EstimatorInterface performance = new ExponentialDecayEstimator();
		...
		public void printStatistics(final PrintStream s, final String lbl) {
			performance.printStatistics(s, lbl);
		}
	}
